...
function getCurrency(currency, wallet, providerUrl, contractAddress) {
    switch (currency) {
        ...
        case "matic":
            return new ethereum_1.default({ name: "matic", ticker: "MATIC", providerUrl: providerUrl !== null && providerUrl !== void 0 ? providerUrl : "https://polygon-rpc.com", wallet });
        case "bnb":
        ...
        case "solana":
            return new solana_1.default({ name: "solana", ticker: "SOL", providerUrl: providerUrl !== null && providerUrl !== void 0 ? providerUrl : "https://ssc-dao.genesysgo.net/", wallet });
        case "avalanche":
